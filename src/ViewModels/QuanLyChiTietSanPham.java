...
public class QuanLyChiTietSanPham {
    ...
    public QuanLyChiTietSanPham(String idCtsp, String moTa, int soLuongTon, double giaNhap, double giaban, int NamBanHang, String hinhAnh, String idKhuyenMai, String idDongSp, String idNSX, String idKieuDang, String idKichCo, String idChatLieu, String idMauSac, String idSanPham, String idThuongHieu, String qrCode) {
        this.idCtsp = idCtsp;
        this.moTa = moTa;
    ...
    public Object[] arriveChiTietSp() {
        return new Object[]{idCtsp, moTa, soLuongTon, giaNhap, giaban, NamBanHang, hinhAnh, idDongSp, idNSX, idKieuDang, idKichCo, idChatLieu, idMauSac, idSanPham, idThuongHieu, qrCode};
    }
}
